...
func main() {
	...
	// r, ok := wc.(io.Reader) // type conversion for another interface, which is io.Reader
	// if ok {
	// 	fmt.Println(r)
	// } else {
	...
	// usecase of the type conversion
	// when you are not usre if you are going to get a pointer or a value
